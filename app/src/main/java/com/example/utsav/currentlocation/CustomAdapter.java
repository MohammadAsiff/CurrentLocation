package com.example.utsav.currentlocation;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
      ...
      /*  TextView name2 = customview.findViewById( R.id.tv2);
        TextView name3 = customview.findViewById( R.id.tv3);*/
        name1.setText(arr1.get(i));
      /*  name2.setText(arr1.get(i));
        name3.setText(arr1.get(i));*/
        return customview;
    }
}
